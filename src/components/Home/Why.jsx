    ...
    <div className="min-h-screen w-full p-2 sm:p-3 bg-gray-50">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6 px-0">
        ...
        <div className="bg-black/90 rounded-lg p-3 sm:p-4 text-white max-w-full">
          ...
          <p className="text-xs sm:text-sm text-white/90 leading-relaxed">
            Advanced encryption and blockchain verification ensure your vote is secure and tamper-proof.
          </p>
        </div>
        ...
        <div className="bg-black/90 rounded-lg p-3 sm:p-4 text-white max-w-full">
          ...
          <p className="text-xs sm:text-sm text-white/90 leading-relaxed">
            Real-time tracking and public audit trails. Every vote counts and can be verified.
          </p>
        </div>
      ...
      <div className="min-h-[40vh] w-full">
        <div className='w-full h-full bg-black/90 rounded-xl relative flex flex-col items-center justify-center p-4 lg:p-8 text-center'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 w-full max-w-md'>
            <button className='bg-blue-400 text-white font-semibold text-lg sm:text-xl py-3 px-6 rounded-lg cursor-pointer hover:bg-blue-500 transition-colors duration-200 flex-1'>
              Get Started
            </button>
            <button className='bg-white text-blue-600 font-semibold text-lg sm:text-xl py-3 px-6 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors duration-200 flex-1'>
              View Demo
            </button>
          </div>
        </div>
